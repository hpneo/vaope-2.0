...
$.extend($.facebox,{settings:{opacity:0,overlay:true,loadingImage:'http://vaope.com/plantillas/js/facebox/loading.gif',closeImage:'http://vaope.com/plantillas/js/facebox/closelabel.gif',imageTypes:['png','jpg','jpeg','gif'],faceboxHtml:'\
